...
public class CommonSharedPreferences {
    ...
    public static final String FILE_NAME = "XB_Launcher_PARAMS";

    public static void put(String key, Object value) {

        SharedPreferences sp = MyApplication.getInstance().getSharedPreferences(FILE_NAME, MODE_MULTI_PROCESS);
    ...
    private static class SharedPreferencesCompat {
        ...
        public static void apply(SharedPreferences.Editor editor) {
            try {
                ...
                e.printStackTrace();
                Log.d("SharedPreferencesCompat",
                        "apply(SharedPreferencesCompat.java:76)" + e.toString());
            } catch (InvocationTargetException e) {
                e.printStackTrace();
                Log.e("SharedPreferencesCompat",
                        "apply(SharedPreferencesCompat.java:81)" + e.toString());
            }
            editor.commit();
        }
